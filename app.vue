...
const props = defineProps({
  ...
  title: {
    type: String,
    default: "Arda KALAYCI",
  },
  readDocs: {
    type: String,
    default:
      "We highly recommend you take a look at the Arda documentation, whether you are new or have previous experience with the framework.",
  },
  followTwitter: {
    type: String,
    default:
      "Follow the Arda Twitter account to get latest news about releases, new modules, tutorials and tips.",
  },
  starGitHub: {
    type: String,
    default:
      "Arda is open source and the code is available on GitHub, feel free to star it, participate in discussions or dive into the source.",
  },
});
useHead({
  title: `${props.title}`,
  ...
  >
    <div class="grid grid-cols-3 gap-4 md:gap-8 max-w-5xl w-full z-20">
      ...
      <a
        ...
        <h5 class="font-semibold text-xl mt-4">Wikim</h5>
        <p class="mt-2" v-text="readDocs" /></a
      ><a
        href="https://github.com/ardakalayci"
        target="_blank"
        rel="noopener"
        class="
          cursor-pointer
      ...
      ><a
        href="https://twitter.com/OfficialKalayci"
        target="_blank"
        rel="noopener"
        class="
          cursor-pointer
